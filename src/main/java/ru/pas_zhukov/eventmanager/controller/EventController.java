...
public class EventController {
    ...
    public EventController(EventConverter eventConverter, EventService eventService, AuthenticationService authenticationService, EventPermissionService eventPermissionService) {
